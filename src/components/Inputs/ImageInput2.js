  ...
  return (
    <>
      <TouchableOpacity
        style={
          !image
            ? CmnStyles.businessLogoUploadBox2a
            : CmnStyles.businessLogoUploadBox2a
        }
        onPress={() => {
        ...
        {!image ? (
          <>
            <Image
              ...
              style={CmnStyles.businessLogoUploadImage4}
              resizeMode="contain"
            />
            <Text style={TextStyles.Orange_9_400}>Upload {text}</Text>
          </>
        ) : (
          <>
            {activityIndicator && (
            ...
            <Image
              source={{uri: image}}
              style={CmnStyles.businessLogoUploadImage2a}
              resizeMode={'stretch'}
              onLoadStart={() => {
